...
#include "VoIPReplication.generated.h"
...
class VOIPAVATARS_API UVoIPReplication : public UActorComponent
{
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Network")
		bool RegisterVoIPForReplication(USceneComponent* Head, USceneComponent* LeftHand, USceneComponent* RightHand);
...
protected:
	...
	UPROPERTY(ReplicatedUsing = OnRep_ReplicatedTransforms)
		FVoIPReplicationData ReplicatedVRBodyTransforms;

	UFUNCTION(Server, Unreliable, WithValidation, Category = "Network")
		void Server_UpdateReplicationData(const FVoIPReplicationData& UpdatedData);
