...
public class VoIPAvatars : ModuleRules
{
	public VoIPAvatars(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        PublicIncludePaths.AddRange
			...
			new string[]
            {
                BaseDirectory + "/VoIPAvatars/Public",
                // Access to VoIPOvrAvatarHelpers.h
                BaseDirectory + "/VoIPAvatars/Private",
