...
FOvrAvatarManager& FOvrAvatarManager::Get()
{
	/*if (!sAvatarManager)
	{
		sAvatarManager = NewObject<FOvrAvatarManager>();
...
UTexture2D* FOvrAvatarManager::LoadTexture(const uint64_t id, const ovrAvatarTextureAssetData* data, bool isLinearColor)
{
...
UTexture* FOvrAvatarManager::FindTexture(uint64_t id)
{
...
void FOvrAvatarManager::CacheRoughnessMapID(uint64_t id)
{
