...
// We need these for use in Unreal applications, but unfortunately can't include VxcErrors.h
// without pulling in tons of extra code we don't want, so we must capture specific content
