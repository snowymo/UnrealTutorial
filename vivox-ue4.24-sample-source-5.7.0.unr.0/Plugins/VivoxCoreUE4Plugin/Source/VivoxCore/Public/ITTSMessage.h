...
public:
    ...
    /**
     * \brief Voice used to synthesize this message
     */
    ...
    /**
     * \brief Internal Utterance Identifier
     */
    ...
    /**
     * \brief True if created using non-default constructor and Text is not empty
     */
