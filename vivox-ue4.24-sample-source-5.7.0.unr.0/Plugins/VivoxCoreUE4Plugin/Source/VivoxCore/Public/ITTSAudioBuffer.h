...
/**
  * \brief Text-To-Speech synthesized into an audio buffer for direct use
  */
...
public:
    ...
    /**
     * \brief PCM buffer of synthesized speech
     */
    ...
    /**
     * \brief The number of channels the audio in the buffer consists of
     */
    virtual const int &NumChannels() const = 0;

    /**
     * \brief True if speech buffer not empty
     */
