#pragma once
#if !defined(__ORBIS__) && !defined(_XBOX) && !defined(_XBOX_ONE) && !TARGET_OS_IPHONE && !defined(__android__) && !defined(_UAP) && !defined(VXP_LINUX)
...
# else
# if defined(_UAP)
        const char *pVX_TEST_UDP_HEADER  = "0";
        const char *pVX_TEST_UDP_TRAILER = "0";
# else
